...
export class Sequelize extends Hooks {
   ...
   * @param fn   A callback function that is called with options
   */
  public static beforePoolAcquire(
    name: string,
   ...
   * @param fn   A callback function that is called with options
   */
  public static afterPoolAcquire(
    name: string,
 ...
 */
export function where<Op extends keyof WhereOperators>(
...
export function where(
  ...
  rightOperand: WhereAttributeHashValue<any>
): Where;
