...
import {
  ...
  QueryOptions,
  TableName,
} from "sequelize/types/dialects/abstract/query-interface";
 ...
 */
type StaticValues<Type> = Type extends Range<infer RangeType>
  ? [
      lower: RangeType | RangePart<RangeType>,
...
export interface NonNullFindOptions<TAttributes = any>
 ...
 */
export interface FindOrBuildOptions<
  TAttributes = any,
  TCreationAttributes = TAttributes
> extends FindOptions<TAttributes>,
    BuildOptions {
 ...
 */
export interface TruncateOptions<TAttributes = any>
  extends Logging,
    Transactionable,
    Filterable<TAttributes>,
    Hookable {
...
export interface DestroyOptions<TAttributes = any>
  extends TruncateOptions<TAttributes> {
  /**
...
> {
   ...
   */
  public static getAttributes<M extends Model>(
    this: ModelStatic<M>
  ): {
   ...
   */
  constructor(
    values?: MakeNullishOptional<TCreationAttributes>,
    options?: BuildOptions
  );
  ...
  public previous<K extends keyof TModelAttributes>(
    key: K
  ): TModelAttributes[K] | undefined;
   ...
   */
  public update<K extends keyof TModelAttributes>(
    key: K,
  ...
  public update(
    keys: {
      [key in keyof TModelAttributes]?:
        | TModelAttributes[key]
        | Fn
        | Col
        | Literal;
    },
 ...
 */
export type CreationAttributes<M extends Model | Hooks> = MakeNullishOptional<
